      ...
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <div className="hidden md:flex items-center gap-8 ml-12 text-sm font-medium tracking-wide">
            <Link to="/" className="text-white hover:text-zinc-300 transition-colors">NEW ARRIVALS</Link>
            <Link to="/" className="text-zinc-400 hover:text-white transition-colors">COLLECTIONS</Link>
            <Link to="/" className="text-zinc-400 hover:text-white transition-colors">EDITORIAL</Link>
          </div>
        </div>
