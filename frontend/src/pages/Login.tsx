...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-black flex text-white font-sans selection:bg-white selection:text-black">
      {/* Left side: Beautiful image & Glassmorphism */}
      <div className="hidden lg:flex w-1/2 relative items-center justify-center overflow-hidden border-r border-white/5">
        ...
        <motion.div 
          ...
          className="relative z-10 p-12 bg-black/20 backdrop-blur-xl border border-white/10 rounded-3xl max-w-lg shadow-2xl"
        >
          <h1 className="text-5xl font-bold tracking-tighter mb-4">Welcome Back.</h1>
          <p className="text-zinc-400 text-lg font-light leading-relaxed">
            Enter the world of minimalist luxury. Your curated experience awaits.
          </p>
        </motion.div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative">
        ...
        >
          <div className="mb-10 text-center">
            ...
            <h2 className="text-2xl font-medium tracking-tight mt-2">Sign in to your account</h2>
            <p className="text-zinc-500 mt-2 text-sm">Don't have an account? <Link to="/signup" className="text-white hover:underline">Sign up</Link></p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <Link to="#" className="text-xs text-zinc-500 hover:text-white transition-colors">Forgot password?</Link>
              </div>
              <input 
                type="password" 
                required
          ...
          <div className="mt-8">
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              <button 
                type="button" 
                onClick={() => alert("Google OAuth is coming soon!")}
                className="flex items-center justify-center gap-2 w-full px-4 py-3 border border-zinc-800 rounded-xl hover:bg-zinc-900 transition-colors"
              >
              ...
              <button 
                type="button" 
                onClick={() => alert("GitHub OAuth is coming soon!")}
                className="flex items-center justify-center gap-2 w-full px-4 py-3 border border-zinc-800 rounded-xl hover:bg-zinc-900 transition-colors text-white"
              >
